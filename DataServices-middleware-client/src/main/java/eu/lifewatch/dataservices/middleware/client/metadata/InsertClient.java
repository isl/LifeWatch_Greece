...
public class InsertClient {
    ...
    private static void insertMicroCTPostProcessing(){
        try{
            ...
            struct.setDatasetURI("http://localhost/microct/dataset");
            struct.setDatasetTitle("microct dataset");
            ...
            input2.setKey("http://localhost/microctscanning/product2");
            input2.setValue("microct scanning product 2");
            Pair input3=new Pair();
            input3.setKey("http://localhost/microctreconstruction/product1");
            input3.setValue("microct reconstruction product 1");
            Pair input4=new Pair();
            input4.setKey("http://localhost/microctreconstruction/product2");
            input4.setValue("microct reconstruction product 2");
            struct.inputs=Arrays.asList(input1,input2,input3,input4);
    ...
    private static void insertMicroCTScanning(){
        try{
            ...
            struct.setDatasetURI("http://localhost/microct/dataset");
            struct.setDatasetName("microct dataset");
    ...
    private static void insertMicroCTSpecimen(){
        try{
            ...
            struct.setDatasetURI("http://localhost/microct/dataset");
            struct.setDatasetName("microct dataset");
            struct.setDescription("microct description");
            ...
            struct.setSpeciesName("microct species");
            struct.setSpeciesURI("http://localhost/microct/species");
            struct.setCollectionURI("http://localhost/microct/collection");
            struct.setCollectionName("microct collection");
            ...
            struct.setSpecimenName("microct specimen");
            struct.setSpecimenType("microct specimen type");
            struct.setSpecimenURI("http://localhost/microct/specimen");
