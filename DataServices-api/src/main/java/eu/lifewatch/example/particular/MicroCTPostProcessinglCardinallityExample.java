...
/** NOT TESTED
 * 
 * This class is used for testing the cardinality issues of MicroCTPostPorcessinStruct. 
 * Information about the virtuoso repository that is being used can be found at beans.xml file.
 * 
 * @author Nikos Minadakis (minadakn 'at' ics 'dot' forth 'dot' gr)
 * @author Yannis Marketakis (marketak 'at' ics 'dot' forth 'dot' gr)
 */
public class MicroCTPostProcessinglCardinallityExample {
    private MetadataRepositoryService mrService;
    private static final String defaultGraphspace="http://www.ics.forth.gr/isl/directoryService/cardinality/microctpostprocessing/example";
    
    public MicroCTPostProcessinglCardinallityExample createMRManager(){
    ...
    public MicroCTPostProcessinglCardinallityExample insertSomeData(){
        MicroCTPostProcessingStruct struct1=new MicroCTPostProcessingStruct().withPostProcessingURI("http://localhost/postprocessing1")
        ...
        MicroCTPostProcessingStruct struct2=new MicroCTPostProcessingStruct().withPostProcessingURI("http://localhost/postprocessing2")
        ...
        MicroCTPostProcessingStruct struct3=new MicroCTPostProcessingStruct().withPostProcessingURI("http://localhost/postprocessing3")
        ...
        MicroCTPostProcessingStruct struct4=new MicroCTPostProcessingStruct().withPostProcessingURI("http://localhost/postprocessing4")
    ...
    public MicroCTPostProcessinglCardinallityExample search(){
        try{
            List<MicroCTPostProcessingStruct> structs=this.mrService.searchMicroCTPostProcessing("species 1", "specimen 1", "input 1", "",defaultGraphspace);
            System.out.println("Found "+structs.size()+" structs");
            for(MicroCTPostProcessingStruct struct : structs){
    ...
    public static void main(String[] args){
        new MicroCTPostProcessinglCardinallityExample().createMRManager()
                          .insertSomeData()
                          .search();
    }
}