...
//            }
//            this.service=new EventService(new VirtuosoRepositoryManager(url, port, username, password));
...
//    @Test
//    public void testEventByActor(){
//        try{
//            List<Map<String,String>> results=this.service.getEventByActor("http://localhost/actor");
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testEventFromPlace(){
//        try{
//            List<Map<String,String>> results=this.service.getEventFromPlace("http://localhost/place");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//        try{
//            List<Map<String,String>> results=this.service.getEventFromTime("http://localhost/timespan");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testEventHasMetActor(){
//        try{
//            List<Map<String,String>> results=this.service.getEventHasMetActor("http://localhost/actor");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testEventHasMetThing(){
//        try{
//            List<Map<String,String>> results=this.service.getEventHasMetThing("http://localhost/thing");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testEventMeasuredDimension(){
//        try{
//            List<Map<String,String>> results=this.service.getEventMeasuredDimension("dimension_value");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
