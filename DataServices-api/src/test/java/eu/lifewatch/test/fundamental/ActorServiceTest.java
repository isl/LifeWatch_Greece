...
//            }
//            this.service=new ActorService(new VirtuosoRepositoryManager(url, port, username, password));
...
//    @Test
//    public void testActorHasMetPlace(){
//        try{
//            List<Map<String,String>> results=this.service.getActorHasMetPlace("http://localhost/place");
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testActorHasMetThing(){
//        try{
//            List<Map<String,String>> results=this.service.getActorHasMetThing("http://localhost/thing");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testActorIsOwnerOrCreatorOfThing(){
//        try{
//            List<Map<String,String>> results=this.service.getActorIsOwnerOrCreatorOfThing("http://localhost/thing");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testActorRefersToEvent(){
//        try{
//            List<Map<String,String>> results=this.service.getActorRefersToEvent("http://localhost/event");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testActorRefersToThing(){
//        try{
//            List<Map<String,String>> results=this.service.getActorRefersToThing("http://localhost/thing");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testActorRefersFromPlace(){
//        try{
//            List<Map<String,String>> results=this.service.getActorFromPlace("http://localhost/place");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testActorRefersFromTime(){
//        try{
//            List<Map<String,String>> results=this.service.getActorFromTime("http://localhost/timespan");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testActorMeasuredDimension(){
//        try{
//            List<Map<String,String>> results=this.service.getActorMeasuredDimension("http://localhost/dimension");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
