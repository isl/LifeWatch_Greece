...
//            }
//            this.service=new DimensionService(new VirtuosoRepositoryManager(url, port, username, password));
...
//    @Test
//    public void testDimensionByActor(){
//        try{
//            List<Map<String,String>> results=this.service.getDimensionByActor("http://localhost/actor");
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testDimensionByEvent(){
//        try{
//            List<Map<String,String>> results=this.service.getDimensionByEvent("http://localhost/event");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testDimensionOfPlace(){
//        try{
//            List<Map<String,String>> results=this.service.getDimensionOfPlace("http://localhost/place");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testDimensionOfThing(){
//        try{
//            List<Map<String,String>> results=this.service.getDimensionOfThing("http://localhost/thing");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
