 ...
 */
public class ThingServiceTest extends TestCase{
...
//            }
//            this.service=new ThingService(new VirtuosoRepositoryManager(url, port, username, password));
...
//    @Test
//    public void testThingFromActor(){
//        try{
//            List<Map<String,String>> results=this.service.getThingFromActor("http://localhost/owner");
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testThingFromEvent(){
//        try{
//            List<Map<String,String>> results=this.service.getThingFromEvent("http://localhost/event");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testThingFromPlace(){
//        try{
//            List<Map<String,String>> results=this.service.getThingFromPlace("http://localhost/place");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testThingFromThing(){
//        try{
//            List<Map<String,String>> results=this.service.getThingFromThing("http://localhost/thing");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testThingRefersToEvent(){
//        try{
//            List<Map<String,String>> results=this.service.getThingRefersToEvent("http://localhost/event");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testThingRefersToThing(){
//        try{
//            List<Map<String,String>> results=this.service.getThingRefersToThing("http://localhost/thing");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testThingHasDimension(){
//        try{
//            List<Map<String,String>> results=this.service.getThingHasDimension("dimension");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testThingHasMetActor(){
//        try{
//            List<Map<String,String>> results=this.service.getThingHasMetActor("http://localhost/actor");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testThingHasMetPlace(){
//        try{
//            List<Map<String,String>> results=this.service.getThingHasMetPlace("http://localhost/place");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testThingHasMetThing(){
//        try{
//            List<Map<String,String>> results=this.service.getThingHasMetThing("http://localhost/thing");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testThingHasMetTime(){
//        try{
//            List<Map<String,String>> results=this.service.getThingHasMetTime("http://localhost/time");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testThingByActor(){
//        try{
//            List<Map<String,String>> results=this.service.getThingByActor("actor");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testThingByEvent(){
//        try{
//            List<Map<String,String>> results=this.service.getThingByEvent("http://localhost/event");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
...
//    /*At first we will just test that it will not fail. After finalizing the template SPARQL queries we will fix it. */
//    @Test
//    public void testThingFromTime(){
//        try{
//            List<Map<String,String>> results=this.service.getThingFromTime("http://localhost/timespan");
//            assertNotNull(results);
//        }catch(QueryExecutionException ex){
//            fail("At this point we should encounter this\n"+ex);
//        }
