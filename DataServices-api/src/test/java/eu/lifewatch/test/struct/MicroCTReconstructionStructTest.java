 ...
 */
public class MicroCTReconstructionStructTest extends TestCase{
    private MicroCTReconstructionStruct struct;
    private Repository repository;
    private final String triplesContext="http://localhost/triples";
    
    public MicroCTReconstructionStructTest(){
        this.struct=new MicroCTReconstructionStruct();
    }
    ...
    @Test
    public void testReconstructionUri(){
        String reconstructionUri="http://localhost/reconstruction";
        String altReconstructionUri="http://localhost/reconstruction_using_set";
        assertTrue(this.struct.getReconstructionURI().isEmpty());
        this.struct.withReconstructionURI(reconstructionUri);
        assertEquals(reconstructionUri, struct.getReconstructionURI());
        assertTrue(this.importAndValidateTriples(struct.toNtriples()));
        this.struct.setReconstructionURI(altReconstructionUri);
        assertEquals(altReconstructionUri, struct.getReconstructionURI());
        assertTrue(this.importAndValidateTriples(struct.toNtriples()));
    }
    ...
    public void testAllFields(){
        ...
        this.struct.withDatasetURI(datasetUri)
                   ...
                   .withReconstructionURI(reconstructionUri)
        ...
        assertEquals(reconstructionUri,this.struct.getReconstructionURI());
